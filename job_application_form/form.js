                ...
                con.query(technology,(err4,result5)=>{
                    ...
                    con.query(referance,(err5,result6)=>{
                        ...
                        con.query(preferance,(err6,result7)=>{
                            if(err6) throw err6;
                            con.query("select * from candidate_master where isdeleted='0'",(err7,data)=>{
                              if(err7) throw err7;
                                 res.render('datalist.ejs',{stringsearch2:'',result:data});
                             });
                        });
                    });
                });
...
if(stringsearch == ''){
 ...
 console.log("stringjoint "+stringjoint);
    ...
    con.query(`select * from candidate_master ${stringjoint} `, (err, result) => {
        if (err) throw err;
          
            res.render('datalist', {stringsearch2,result});    
