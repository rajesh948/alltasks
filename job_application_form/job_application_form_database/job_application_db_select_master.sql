...
CREATE TABLE `select_master` (
  ...
  `selectname` varchar(45) NOT NULL,
  `select_key` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `select_key_UNIQUE` (`select_key`)
...
INSERT INTO `select_master` VALUES (1,'state','statekey'),(2,'relation','relationkey'),(3,'course','coursekey'),(4,'language','languagekey'),(5,'Technology','technologykey'),(6,'preflocation','preflocationkey'),(7,'department','departmentkey');
